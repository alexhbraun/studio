...
export const workouts: WorkoutDay[] = [
  ...
  },
  {
      ...
      description: "Entrenamiento avanzado de quema de calorías para maximizar la pérdida de peso y la condición física.",
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulation.", duration: "5", repetitions: null, image: "/day22-warmup.png", imageHint: "morning stretch" },
