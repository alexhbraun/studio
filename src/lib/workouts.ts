...
export const workouts: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
        ...
        { id: 2, name: "Caminata rápida", description: "Mantén un ritmo rápido y constante durante 20 minutos. El desafío de hoy es la resistencia mental y física. A medida que avanzas, tu mente puede decirte que bajes el ritmo. Tu trabajo es mantener la constancia, respirar profundamente y concentrarte en la fuerza de tus piernas. Estás construyendo una resistencia que te servirá en todos los aspectos de tu vida.", duration: "20", repetitions: null },
        { id: 3, name: "Enfriamiento", description: "Termina con 3 minutos de caminata muy lenta. Este enfriamiento activo ayuda a eliminar el ácido láctico de los músculos, reduciendo la posibilidad de agujetas. Usa este tiempo para reflexionar sobre tu progreso. Cada día construyes sobre el anterior. Hoy eres más fuerte de lo que eras ayer. Reconoce tu esfuerzo.", duration: "3", repetitions: null },
    ],
  },
  {
    day: 5,
  ...
  },
  {
    ...
    calories: 220,
    exercises: [
      { id: 1, name: "Caminata de calentamiento", description: "Comienza con 5 minutos de caminata suave. Prepárate mentalmente para los picos de intensidad. Visualízate moviéndote con fuerza y confianza durante las fases de potencia. Recuerda que cada intervalo es una oportunidad para desafiar tus límites y hacerte más fuerte. Hoy das un paso más en tu capacidad atlética.", duration: "5", repetitions: null },
