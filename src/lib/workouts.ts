...
export const workouts: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      { id: 1, name: "Caminata de calentamiento", description: "Una caminata suave de 5 minutos para estimular la circulación y movilizar las articulaciones. Presta atención a un movimiento suelto y relajado.", duration: "5", repetitions: null, image: "/images/workouts/day2-warmup.png", imageHint: "path walking" },
      { id: 2, name: "Caminata rápida y constante", description: "Mantén un ritmo rápido y constante durante 15 minutos. Encuentra un ritmo que puedas mantener bien sin quedarte sin aliento. Tu esfuerzo debe ser notable, pero no abrumador.", duration: "15", repetitions: null, image: "/images/workouts/day2-steady.png", imageHint: "consistent pace" },
      { id: 3, name: "Enfriamiento y estiramiento", description: "Termina la sesión con una caminata lenta. Después, estira suavemente los músculos de las pantorrillas, los muslos y los glúteos durante 20-30 segundos cada uno para promover la flexibilidad.", duration: "5", repetitions: null, image: "/images/workouts/day2-cooldown.png", imageHint: "stretching outdoors" },
    ],
  },
  {
    day: 3,
    ...
    exercises: [
      { id: 1, name: "Calentamiento", description: "Comienza con 5 minutos de caminata ligera. Prepara tu cuerpo mental y físicamente para las secciones más rápidas que vienen.", duration: "5", repetitions: null, image: "/images/workouts/day3-warmup.png", imageHint: "sunrise walk" },
      { id: 2, name: "Intervalos de caminata", description: "Aquí cambiarás el ritmo a propósito: camina rápido durante 2 minutos, seguido de 1 minuto a un ritmo notablemente más rápido que te desafíe. Repite este ciclo durante todo el tiempo.", duration: "20", repetitions: "aprox. 6-7 series", image: "/images/workouts/day3-intervals.png", imageHint: "interval training" },
      { id: 3, name: "Enfriamiento", description: "Reduce drásticamente tu ritmo durante los últimos 5 minutos. Permite que tu pulso se normalice y disfruta de la sensación de haber superado el desafío.", duration: "5", repetitions: null, image: "/images/workouts/day3-cooldown.png", imageHint: "sunset walk" },
    ],
  },
  {
    day: 4,
    ...
    exercises: [
        { id: 1, name: "Caminata de calentamiento", description: "Comienza con 5 minutos de caminata ligera en un entorno tranquilo para entrar en calor y activar los músculos.", duration: "5", repetitions: null, image: "/images/workouts/day4-warmup.png", imageHint: "park walk" },
        { id: 2, name: "Caminata rápida", description: "Mantén un ritmo rápido pero consistentemente cómodo durante 20 minutos. Se trata de cubrir distancia y entrenar la resistencia, no de hacer sprints.", duration: "20", repetitions: null, image: "/images/workouts/day4-brisk.png", imageHint: "steady pace" },
