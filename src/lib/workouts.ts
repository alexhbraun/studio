...
export const workouts: WorkoutDay[] = [
  ...
  },
  {
      ...
      calories: 260,
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulación. Hoy volvemos a los intervalos. Usa el calentamiento para preparar tu mente para los cambios de ritmo. Con cada minuto que pasa, te sientes más preparado y fuerte.", duration: "5", repetitions: null, calories: 30 },
          { id: 2, name: "Intervalos de caminata", description: "Alterna entre 3 minutos de caminata rápida y 1 minuto de caminata potente (power walking). Durante el power walking, usa los brazos activamente y aumenta la frecuencia de los pasos. En las fases de potencia, desafíate a ti mismo un poco más que la última vez. Un paso más rápido, un braceo más enérgico. Es en estos pequeños incrementos donde se produce la verdadera transformación. ¡Tú puedes!", duration: "24", repetitions: "6 series", calories: 200 },
          { id: 3, name: "Caminata de enfriamiento", description: "Disminuye considerablemente la velocidad y sacude los brazos y las piernas. Esto ayuda a tu cuerpo a recuperarse y previene el dolor muscular. Has dominado los intervalos de hoy. Siente el poder que has construido. Tu cuerpo se está adaptando, volviéndose una máquina más eficiente para quemar grasa.", duration: "5", repetitions: null, calories: 30 },
      ]
  },
  {
      day: 10,
  ...
  },
  {
      ...
      calories: 270,
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulación. Hoy, la mente es tan importante como el cuerpo. Despeja tus pensamientos y prepárate para estar presente en cada paso de tu caminata.", duration: "5", repetitions: null, calories: 30 },
          { id: 2, name: "Ritmo rápido", description: "Mantén un ritmo fuerte y rápido que te desafíe pero no te agote. Tu respiración debe ser profunda y controlada. Concéntrate en la 'Técnica Correcta' que has aprendido. ¿Están tus hombros relajados? ¿Tu abdomen activo? ¿Aterrizas con el talón y te impulsas con la punta? Esta caminata consciente maximiza los beneficios de cada movimiento.", duration: "26", repetitions: null, calories: 210 },
          { id: 3, name: "Caminata de enfriamiento", description: "Disminuye considerablemente la velocidad y sacude los brazos y las piernas. Esto ayuda a tu cuerpo a recuperarse y previene el dolor muscular. La concentración que has mantenido ha convertido este entrenamiento en una forma de meditación en movimiento. Llevas contigo no solo los beneficios físicos, sino también una mente más clara y tranquila.", duration: "5", repetitions: null, calories: 30 },
      ]
  },
  {
      day: 12,
  ...
  },
  {
      ...
      calories: 380,
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulación. Hoy nos centramos en mantener el motor en marcha. Una sesión de cardio larga y constante para maximizar la quema de grasa. Prepárate para sudar y sentirte increíble.", duration: "5", repetitions: null, calories: 40 },
          { id: 2, name: "Ritmo rápido", description: "Mantén un ritmo fuerte y rápido que te desafíe pero no te agote. Tu respiración debe ser profunda y controlada. Entra en la zona. Encuentra tu ritmo, pon tu música favorita y deja que los minutos pasen. Estás en un viaje de resistencia, demostrando tu capacidad para perseverar. Cada minuto es una victoria.", duration: "33", repetitions: null, calories: 300 },
          { id: 3, name: "Caminata de enfriamiento", description: "Disminuye considerablemente la velocidad y sacude los brazos y las piernas. Esto ayuda a tu cuerpo a recuperarse y previene el dolor muscular. Fantástico trabajo. Has mantenido a tu cuerpo en la zona de quema de grasa durante un tiempo considerable. Los resultados de sesiones como esta se acumulan rápidamente.", duration: "5", repetitions: null, calories: 40 },
      ]
  },
  {
      day: 21,
  ...
  },
  {
      ...
      calories: 390,
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulation. Comienza la última fase: la consolidación. Hoy se trata de afianzar tu increíble nivel de resistencia. Concéntrate en la sensación de fuerza que tienes ahora.", duration: "5", repetitions: null, calories: 40 },
          { id: 2, name: "Ritmo rápido", description: "Mantén un ritmo fuerte y rápido que te desafíe pero no te agote. Tu respiración debe ser profunda y controlada. Moverse a este ritmo durante tanto tiempo habría parecido imposible hace unas semanas. Ahora, es un desafío que puedes manejar. Siente la potencia en cada paso y la facilidad en tu respiración. Has construido una base increíblemente sólida.", duration: "34", repetitions: null, calories: 310 },
          { id: 3, name: "Caminata de enfriamiento", description: "Disminuye considerablemente la velocidad y sacude los brazos y las piernas. Esto ayuda a tu cuerpo a recuperarse y previene el dolor muscular. Cada sesión de resistencia como esta refina tu motor aeróbico. Estás programando tu cuerpo para ser una máquina eficiente de quemar grasa, incluso en reposo.", duration: "5", repetitions: null, calories: 40 },
      ]
  },
  {
      day: 23,
  ...
  },
  {
      ...
      calories: 420,
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulación. Los intervalos de hoy son una prueba de tu nuevo nivel de potencia. Has hecho esto muchas veces. Confía en tu entrenamiento y en tu fuerza. Estás listo.", duration: "5", repetitions: null, calories: 40 },
          { id: 2, name: "Intervalos de caminata", description: "Alterna entre 3 minutos de caminata rápida y 1 minuto de caminata potente (power walking). Durante el power walking, usa los brazos activamente y aumenta la frecuencia de los pasos. En estos últimos días, los intervalos son para demostrar tu poder. Ve a por ello en las fases de alta intensidad. Sorpréndete a ti mismo con lo rápido y fuerte que puedes ser. ¡Desata tu potencial!", duration: "36", repetitions: "9 series", calories: 340 },
          { id: 3, name: "Caminata de enfriamiento", description: "Disminuye considerablemente la velocidad y sacude los brazos y las piernas. Esto ayuda a tu cuerpo a recuperarse y previene el dolor muscular. Has manejado una sesión de alta intensidad con una duración considerable. Tu capacidad de recuperación es más rápida, tu potencia es mayor. Estás en la cima de tu juego.", duration: "5", repetitions: null, calories: 40 },
      ]
  },
  {
      day: 25,
  ...
  },
  {
      ...
      calories: 430,
      exercises: [
          { id: 1, name: "Caminata de calentamiento", description: "Comienza con una caminata lenta y suave. Rota los hombros y los brazos para aflojar la parte superior del cuerpo y promover la circulación. Penúltimo día. Hoy es una caminata para disfrutar de tu nuevo nivel de fitness. Concéntrate en un movimiento suave, eficiente y potente.", duration: "5", repetitions: null, calories: 40 },
          { id: 2, name: "Ritmo rápido", description: "Mantén un ritmo fuerte y rápido que te desafíe pero no te agote. Tu respiración debe ser profunda y controlada. Esta es tu 'vuelta de honor'. Camina con la cabeza alta, con la confianza de alguien que ha trabajado duro y ha logrado un cambio real. Siente la facilidad y la fuerza en tu zancada. Es el resultado de tu dedicación.", duration: "40", repetitions: null, calories: 350 },
          { id: 3, name: "Caminata de enfriamiento", description: "Disminuye considerablemente la velocidad y sacude los brazos y las piernas. Esto ayuda a tu cuerpo a recuperarse y previene el dolor muscular. Mañana es el gran final. Hoy ha sido la preparación perfecta. Relájate, nútrete bien y duerme profundamente. Te lo has ganado.", duration: "5", repetitions: null, calories: 40 },
      ]
  },
  {
      day: 30,
