...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        <div className="mb-8 p-6 rounded-lg bg-green-100/50 dark:bg-green-900/20 border border-green-200/50 dark:border-green-800/30 text-green-900 dark:text-green-200">
          <h3 className="font-bold text-lg mb-2 flex items-center gap-2"><Leaf size={20} /> Antes de empezar…</h3>
          <p className="mb-3"><strong>¡Respira hondo y relájate!</strong><br />Este plan está pensado para acompañarte, no para exigirte ni causarte estrés. Avanza a tu propio ritmo, escucha a tu cuerpo y recuerda que cada paso cuenta.</p>
          <p className="mb-3">No es necesario completar todos los ejercicios a la perfección ni seguir el plan de manera estricta. Lo más importante es crear el hábito y disfrutar el proceso. Si algún día necesitas hacer menos, descansar o adaptar las caminatas a tus posibilidades, está perfecto.</p>
          <p className="font-semibold mb-2">Tu bienestar es la prioridad.</p>
      ...
      <WorkoutModal
        ...
        onCompleteDay={() => selectedDay && handleCompleteDay(selected.day)}
      />
